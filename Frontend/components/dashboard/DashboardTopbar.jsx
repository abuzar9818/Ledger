...
function DashboardTopbar({ title = "Dashboard", subtitle = "Track your accounts and balances in real time." }) {
  ...
  return (
    <header className="border-b border-slate-200/90 bg-white/85 px-4 py-4 backdrop-blur-sm sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm transition hover:border-teal-300 hover:bg-teal-50/40"
            >
            ...
            {open ? (
              <div className="absolute right-0 z-20 mt-2 w-56 rounded-xl border border-slate-200 bg-white p-2.5 shadow-lg backdrop-blur-sm">
