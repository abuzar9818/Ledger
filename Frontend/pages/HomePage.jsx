...
function HomePage() {
  return (
    <div className="space-y-16 pb-12 pt-3">
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-slate-900 to-teal-950 px-6 py-14 text-white sm:px-10 sm:py-16">
        ...
        <div className="relative max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-slate-200/95">
      ...
      <section className="ui-surface rounded-3xl p-6 sm:p-8">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <div className="rounded-xl bg-gradient-to-br from-slate-50 to-teal-50 p-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Step 1</p>
            <p className="mt-2 text-sm font-medium text-slate-800">Authenticate securely and access your workspace.</p>
          </div>
          <div className="rounded-xl bg-gradient-to-br from-slate-50 to-amber-50 p-4">
          ...
          <div className="rounded-xl bg-gradient-to-br from-slate-50 to-cyan-50 p-4">
